...
# Contribute to Ory Milestone Action<!-- omit in toc -->
...
won't clash with Ory Milestone Action's direction. A great way to do this is via
...
- **Help with open issues.** We have a lot of open issues for Ory Milestone
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/ory/milestone-action/blob/master/.github/workflows/conventional_commits.yml)
