...
seriously. If you believe you have found a security issue in Ory Milestone
...
won't clash or be obviated by Ory Milestone Action's normal direction. A great
way to do this is via
[Ory Milestone Action Discussions](https://github.com/ory/meta/discussions) or
...
- I would like to know what I am agreeing to when I contribute to Ory Milestone
  Action. Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/milestone-action)
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory Milestone
...
- **Helping with open issues.** We have a lot of open issues for Ory Milestone
...
Check out
[Ory Milestone Action Discussions](https://github.com/ory/meta/discussions).
...
If you want to receive regular notifications about updates to Ory Milestone
...
before getting started to ensure your work is consistent with Ory Milestone
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Milestone Action](https://github.com/ory/milestone-action/blob/master/.github/semantic.yml)
   for an overview.
...
[Contributor License Agreement](https://cla-assistant.io/ory/milestone-action).
...
[docs](https://github.com/ory/milestone-action/tree/master/docs) folder.
...
git clone git@github.com:ory/ory/milestone-action.git

# Next you add a git remote that is your fork:
git remote add fork git@github.com:<YOUR-GITHUB-USERNAME-HERE>/ory/milestone-action.git
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the Ory Milestone
